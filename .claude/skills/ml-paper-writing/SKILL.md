...
summary: |-
  Write publication-ready ML/AI papers for NeurIPS, ICML, ICLR, ACL, AAAI, COLM. Use when drafting papers from research repos, structuring arguments, verifying citations, or preparing camera-ready submissions. Includes LaTeX templates, revie...
primaryIntent: writing
intents: ["writing", "research"]
capabilities: ["visualization-reporting"]
domains: ["cs-ai"]
keywords: ["academic writing", "neurips", "icml", "iclr", "acl", "aaai", "colm", "latex", "paper writing", "citations", "research", "ml-paper-writing"]
source: builtin
status: verified
upstream:
  repo: dr-claw
  path: skills/ml-paper-writing
